<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Books_records.aspx.cs" Inherits="Books_records" %>
                            ...
                            <div class="nav-collapse collapse">
                                <ul class="nav">
                                    <li class="active"><a href="index.html">Home</a></li>
                                     <li><a href="add book.aspx">Add Books</a></li>
                                     <li><a href="Books_records.aspx">Book Records</a></li>
                            ...
                            <ul class="grid effect-8" id="grid">
                              <li>
                                <div class="block">
                                    ...
                                    <br /><br /><br />
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Width="100%">
                                        <Columns>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:libraryConnectionString %>" SelectCommand="SELECT [Book_Name], [Author_name], [Book_Price] FROM [Books]"></asp:SqlDataSource>
                                    <br /><br />
